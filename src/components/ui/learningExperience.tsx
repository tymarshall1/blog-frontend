function LearningExperience() {
  return (
    <div
      ...
      className="flex flex-col items-center justify-center gap-4 p-2 text-center text-white bg-no-repeat bg-cover border-2 rounded min-h-48 bg-sideNav border-white/20"
    >
